...
| 7 | — | feat: optionally print employer contributions on the salary slip (`show_employer_contributions_in_salary_slip`, off by default) | pending (forward-port to `develop`) |
